...
class TestExtractRepoNameFromUrl:
    ...
    def test_extract_repo_name_gitcode_urls(self):
        """Test repository name extraction from GitCode URLs"""
        ...
        gitcode_git = "https://gitcode.com/owner/repo.git"
        result = self.db_manager._extract_repo_name_from_url(gitcode_git, "gitcode")
        assert result == "owner_repo"
        
        print("✓ GitCode URL tests passed")
