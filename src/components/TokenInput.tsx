...
interface TokenInputProps {
  ...
  setSelectedPlatform: (value: 'gitcode' | 'github' | 'gitlab' | 'bitbucket' ) => void;
  accessToken: string;
            ...
            <div className="mb-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-md border transition-all ${selectedPlatform === 'gitcode'
