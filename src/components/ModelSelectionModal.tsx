...
interface ModelSelectionModalProps {
  ...
  repositoryType?: 'github' | 'gitlab' | 'gitcode' | 'bitbucket';
  // Authentication
...
export default function ModelSelectionModal({
  ...
  const [localSelectedPlatform, setLocalSelectedPlatform] = useState<'github' | 'gitlab'| 'gitcode' | 'bitbucket'>(repositoryType);
