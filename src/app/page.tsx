...
import { FaWikipediaW, FaCoffee, FaWeixin } from 'react-icons/fa';
...
export default function Home() {
  ...
  const [repositoryInput, setRepositoryInput] = useState('https://gitcode.com/huqi/deepwiki-open');
  ...
  const [selectedPlatform, setSelectedPlatform] = useState<'github' | 'gitlab' | 'gitcode' | 'bitbucket'>('gitcode');
  ...
  const parseRepositoryInput = (input: string): {
    ...
    // Handle Unix/Linux absolute paths (e.g., /path/to/folder)
      ...
      if (domain?.includes('github.com')) {
        ...
        type = 'gitlab';
      } else if (domain?.includes('gitcode.com') || domain?.includes('gitcode.')) {
        type = 'gitcode';
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    if (!parsedRepo) {
      setError('Invalid repository format. Use "owner/repo", GitHub/GitLab/GitCode/BitBucket URL, or a local folder path like "/path/to/folder" or "C:\\path\\to\\folder".');
      return;
    }
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  placeholder={t('form.repoPlaceholder') || "owner/repo, GitHub/GitLab/GitCode/BitBucket URL, or local folder path"}
        ...
        <div
          ...
          <div
            ...
            <div className="grid grid-cols-1 gap-3 text-xs text-[var(--muted)]">
              ...
              >https://gitcode.com/huqi/deepwiki-open
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
              ...
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
              >https://gitcode.com/gitcode-org/gitcode
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
        ...
        <div
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-5">
              <a href="https://gitcode.com/huqi/deepwiki-open" target="_blank" rel="noopener noreferrer"
                className="text-[var(--muted)] hover:text-[var(--accent-primary)] transition-colors">
                {/* <FaGithub className="text-xl" /> */}
                <img src="gitcode.png" width={20} height={20} className="text-xl" />
              </a>
              <a href="https://raw.gitcode.com/huqi/huqi/raw/main/donate.jpg" target="_blank" rel="noopener noreferrer"
                className="text-[var(--muted)] hover:text-[var(--accent-primary)] transition-colors">
                <FaCoffee className="text-xl" />
              </a>
              <a href="https://raw.gitcode.com/huqi/huqi/raw/main/Hugi66.png" target="_blank" rel="noopener noreferrer"
                className="text-[var(--muted)] hover:text-[var(--accent-primary)] transition-colors">
