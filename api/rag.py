...
9. For pipe characters (|) in text, write them directly without escaping them"""
    ...
    def prepare_retriever(self, repo_url_or_path: str, type: str = "github", access_token: str = None,
        ...
        # Generate embeddings
        # The `documents` variable here refers to the documents processed by `prepare_database`
        # which are then returned as `self.transformed_docs`.
        # The logging should be placed after `prepare_database` returns the documents.
